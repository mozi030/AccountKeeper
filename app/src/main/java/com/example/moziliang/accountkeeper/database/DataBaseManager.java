package com.example.moziliang.accountkeeper.database;
...
import com.example.moziliang.accountkeeper.BaseApplication;
...
public class DataBaseManager {
    ...
    public boolean CheckColumnDuplicated(DataFormat data, String checkedColumnName) {
        ...
        for (DataFormat row : allRows) {
            if (row.getValueByName(checkedColumnName).equals(data.getValueByName(checkedColumnName))) {
                return true;
            }
        }
        return false;
...
//        String whereClause = AccountDataFormat.KEY_ACCOUNT_NAME + " = ? OR " + AccountDataFormat.KEY_CURRENCY_TYPE + " = ?";
...
//        String sortOrder =
//                AccountDataFormat.KEY_ACCOUNT_NAME + " DESC";
